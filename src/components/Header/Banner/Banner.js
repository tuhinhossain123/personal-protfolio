      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-10 lg:gap-[148px]">
        <div className="px-16 md:px-8 lg:px-0">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[100px] font-bold pt-3 lg:pt-0 lg:leading-[1]">
            UI & UX <br />
            <span className="pl-[8rem] md:pl-[12rem] lg:pl-[15rem]">Designer</span>{" "}
          </h1>

          <p className="text-[21px]  font-normal text-justify  lg:text-justify pt-[28px]">
            Lorem ipsum dolor sit amet consectetur. Tristique amet sed massa
            nibh <br className="block md:hidden lg:block"/> lectus netus in. Aliquet donec morbi convallis Aliquet
            donec Aliquet do <br className="block md:hidden lg:block"/> pretium. Turpis tempus pharetra
          </p>
